...
struct OAuthSigner {
    ...
    func signedRequest(_ method: HTTPMethod, url: URL, params: [String: String]) -> URLRequest {
        ...
        request.setValue("Twitter-iPhone/8.75.1 iOS/15.0 (Apple;iPhone10,1;;;;;0)", forHTTPHeaderField: "User-Agent")
        request.setValue("OAuth " + header, forHTTPHeaderField: "Authorization")
        return request
    }
}
